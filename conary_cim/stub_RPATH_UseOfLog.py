...
class RPATH_UseOfLog(CIMProvider2):
    """Instrument the CIM class RPATH_UseOfLog 

    ManagedSystemElements may record their event, error or informational
    data within Logs. The use of a Log to hold a ManagedSystemElement\'s
    data is described by this association. The type of Element data
    captured by the Log can be specified using the RecordedData string
    property.
    ...
    def enum_instances(self, env, model, keys_only):
        ...
        while False: # TODO more instances?
            ...
            # Key properties    
            #model['Dependent'] = pywbem.CIMInstanceName(classname='CIM_ManagedSystemElement', ...) # TODO (type = REF (pywbem.CIMInstanceName(classname='CIM_ManagedSystemElement', ...))    
            #model['Antecedent'] = pywbem.CIMInstanceName(classname='CIM_Log', ...) # TODO (type = REF (pywbem.CIMInstanceName(classname='CIM_Log', ...))
            if keys_only:
                yield model
            else:
                try:
    ...
    def references(self, env, object_name, model, result_class_name, role,
        ...
        if ch.is_subclass(object_name.namespace, 
                          ...
                          super='CIM_ManagedSystemElement') or \
...
## end of class RPATH_UseOfLogProvider
