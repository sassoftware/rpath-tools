...
"""Python Provider for RPATH_SurveyConcreteJob

Instruments the CIM class RPATH_SurveyConcreteJob
...
class RPATH_SurveyConcreteJob(CIMProvider2):
    """Instrument the CIM class RPATH_SurveyConcreteJob 
    ...
    def get_instance(self, env, model):
        ...
        #model['JobResults'] = [pywbem.CIMInstanceName(classname='None', ...),] # TODO 
    ...
    def cim_method_requeststatechange(self, env, object_name,
        ...
        """Implements RPATH_SurveyConcreteJob.RequestStateChange()
    ...
    def cim_method_geterror(self, env, object_name):
        """Implements RPATH_SurveyConcreteJob.GetError()
    ...
    def cim_method_killjob(self, env, object_name,
        ...
        """Implements RPATH_SurveyConcreteJob.KillJob()
...
## end of class RPATH_SurveyConcreteJobProvider
    
## get_providers() for associating CIM Class Name to python provider class name
    
def get_providers(env): 
    rpath_surveyconcretejob_prov = RPATH_SurveyConcreteJob(env)  
    return {'RPATH_SurveyConcreteJob': rpath_surveyconcretejob_prov} 
